...
```
ZigHandler(config: ZigConfig, base_dir: Path, **kwargs: Any)
...
```
collect(identifier: str, options: ZigOptions) -> CollectorItem
...
```
ZigInputConfig(options: Annotated[ZigInputOptions, _Field(description='Configuration options for collecting and rendering objects.')] = ZigInputOptions())
...
```
options: Annotated[ZigInputOptions, _Field(description='Configuration options for collecting and rendering objects.')] = field(default_factory=ZigInputOptions)
...
```
extra: Annotated[dict[str, Any], _Field(group='general', description='Extra options.')] = field(default_factory=dict)
...
```
heading_level: Annotated[int, _Field(group='headings', description='The initial heading level to use.')] = 2
...
```
show_symbol_type_heading: Annotated[bool, _Field(group='headings', description='Show the symbol type in headings (e.g. mod, class, meth, func and attr).')] = False
...
```
show_symbol_type_toc: Annotated[bool, _Field(group='headings', description='Show the symbol type in the Table of Contents (e.g. mod, class, methd, func and attr).')] = False
...
```
ZigOptions(extra: Annotated[dict[str, Any], _Field(group='general', description='Extra options.')] = dict(), heading: Annotated[str, _Field(group='headings', description='A custom string to override the autogenerated heading of the root object.')] = '', heading_level: Annotated[int, _Field(group='headings', description='The initial heading level to use.')] = 2, show_symbol_type_heading: Annotated[bool, _Field(group='headings', description='Show the symbol type in headings (e.g. mod, class, meth, func and attr).')] = False, show_symbol_type_toc: Annotated[bool, _Field(group='headings', description='Show the symbol type in the Table of Contents (e.g. mod, class, methd, func and attr).')] = False, toc_label: Annotated[str, _Field(group='headings', description='A custom string to override the autogenerated toc label of the root object.')] = '')
...
```
get_handler(handler_config: MutableMapping[str, Any], tool_config: MkDocsConfig, **kwargs: Any) -> ZigHandler
